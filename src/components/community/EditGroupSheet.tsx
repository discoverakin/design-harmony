...
const EditGroupSheet = ({ group, onSave }: EditGroupSheetProps) => {
  ...
  // Reset to current group values when sheet opens
  useEffect(() => {
    if (open) {
      setName(group.name);
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="bottom" className="rounded-t-2xl max-h-[85vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Meeting Schedule */}
          <div className="space-y-1.5">
            <Label htmlFor="edit-group-schedule" className="text-xs font-semibold">
              Meeting Schedule
            </Label>
            <Input
          ...
          {/* Location */}
          <div className="space-y-1.5">
            <Label htmlFor="edit-group-location" className="text-xs font-semibold">
              Location
            </Label>
            <Input
