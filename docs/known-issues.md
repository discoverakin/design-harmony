...
- **Distance math is elliptical.** Euclidean distance over raw lat/lng degrees treats them as equal, but at 42°N a longitude degree is ~74% as wide, so the 0.8-mi radius is wider east-west than north-south.
